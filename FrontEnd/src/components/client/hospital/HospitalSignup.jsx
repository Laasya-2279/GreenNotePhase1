...
import AuroraWavesHospitalBackground from './AuroraWavesHospitalBackground'; // already correct if file is in same folder

export default function HospitalSignup({ onBack }) {
